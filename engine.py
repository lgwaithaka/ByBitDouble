...
class CompoundTradingEngine:
    ...
    async def scan_and_trade(self):
        ...
        # do the heavy lifting. We simply scan more symbols during deep-market
        # hours and fewer during thin hours to maximise fill quality.
        #   High  (00-04, 12-21 UTC): London + NY sessions, Asia open — full scan
        #   Med   (04-08, 21-24 UTC): Asia main + pre-London — moderate scan
        #   Low   (08-12 UTC):        quiet crossover hours  — lean scan
        _h = datetime.now(timezone.utc).hour
        if (_h >= 12 and _h < 21) or (_h >= 0 and _h < 4):
            liq_session = "HIGH";  n_syms = n_syms          # full scan
        ...
        # Confidence floor unchanged — signal quality never compromised by time of day
